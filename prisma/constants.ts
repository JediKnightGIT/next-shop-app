...
export const products = [
  ...
  {
    name: 'Чикенбургер',
    imageUrl: '/burgers/chickenburger.webp',
    categoryId: 1,
  },
  {
    name: 'Цезарь Ролл',
    imageUrl: '/burgers/cezar_roll.webp',
    categoryId: 1,
  },
  {
    name: 'Шримп Ролл',
    imageUrl: '/burgers/shrimp_roll.webp',
    categoryId: 1,
  },
  {
    name: 'Биг Спешиал Ролл',
    imageUrl: '/burgers/big_special_roll.webp',
    categoryId: 1,
  },
  {
    name: 'Лимонад Капри',
    imageUrl: '/drinks/kapri.webp',
    categoryId: 3,
  },
  {
    name: 'Санрайз Малина-ежевика',
    imageUrl: '/drinks/sunrise_malina_ezhevika.webp',
    categoryId: 3,
  },
  {
    name: 'Яблочный Шорли',
    imageUrl: '/drinks/apple_shorli.webp',
    categoryId: 3,
  },
  {
    name: 'Молочный коктейль Папайя-манго',
    imageUrl: '/drinks/milk_cocktail_papaya_mango.webp',
    categoryId: 3,
  },
  {
    name: 'Флэт Уайт',
    imageUrl: '/coffee/flat_white.webp',
    categoryId: 4,
  },
  {
    name: 'Айс Кофе Лесной Орех',
    imageUrl: '/coffee/ice_coffee_lesnoy_oreh.webp',
    categoryId: 4,
  },
  {
    name: 'Айс Кофе Лесной орех на миндальной основе',
    imageUrl: '/coffee/ice_coffee_lesnoy_oreh_almond.webp',
    categoryId: 4,
  },
  {
    name: 'Двойной Эспрессо',
    imageUrl: '/coffee/double_espresso.webp',
    categoryId: 4,
  },
  {
    name: 'Лимонный тарт',
    imageUrl: '/deserts/lemon_tart.webp',
    categoryId: 5,
  },
  {
    name: 'Торт Шоколадный',
    imageUrl: '/deserts/chocolate_cake.webp',
    categoryId: 5,
  },
  {
    name: 'Клубничный Чизкейк',
    imageUrl: '/deserts/strawberry_cheesecake.webp',
    categoryId: 5,
  },
  {
    name: 'Тирамису',
    imageUrl: '/deserts/tiramisu.webp',
    categoryId: 5,
  },
  {
    name: 'Чизкейк Классический',
    imageUrl: '/deserts/classic_cheesecake.webp',
    categoryId: 5,
  },
  {
    name: 'Вафельный рожок',
    imageUrl: '/deserts/ice_cream_cone.webp',
    categoryId: 5,
  },
  {
    name: 'Пирожок Вишнёвый',
    imageUrl: '/deserts/cherry_pie.webp',
    categoryId: 5,
  },
  {
    name: 'Мороженое Карамельное',
    imageUrl: '/deserts/caramel_ice_cream.webp',
    categoryId: 5,
  },
  {
    name: 'Мороженое Клубничное',
    imageUrl: '/deserts/strawberry_ice_cream.webp',
    categoryId: 5,
  },
  {
    name: 'Мороженое Шоколадное',
    imageUrl: '/deserts/chocolate_ice_cream.webp',
    categoryId: 5,
  },
  {
    name: 'Соус Сырный',
    imageUrl: '/sauces/cheese.webp',
    categoryId: 6,
  },
  {
    name: 'Соус Кисло-сладкий',
    imageUrl: '/sauces/sweet_and_sour.webp',
    categoryId: 6,
  },
  {
    name: 'Соус Терияки',
    imageUrl: '/sauces/teriyaki.webp',
    categoryId: 6,
  },
  {
    name: 'Соус Чесночный',
    imageUrl: '/sauces/garlic.webp',
    categoryId: 6,
  },
  {
    name: 'Соус Кетчуп',
    imageUrl: '/sauces/ketchup.webp',
    categoryId: 6,
  },
  {
    name: 'Соус Горчичный',
    imageUrl: '/sauces/mustard.webp',
    categoryId: 6,
  },
  {
    name: 'Соус Барбекю',
    imageUrl: '/sauces/bbq.webp',
    categoryId: 6,
  },
  {
    name: 'Соус Цезарь',
    imageUrl: '/sauces/cezar.webp',
    categoryId: 6,
  },
  {
    name: 'Оливковое масло',
    imageUrl: '/sauces/olive_oil.webp',
    categoryId: 6,
  },
];
